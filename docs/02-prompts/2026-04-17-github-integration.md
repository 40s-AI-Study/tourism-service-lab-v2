...
>
> 그리고 llm-wiki 로 정리되는 내용들도 모두 https://github.com/40s-AI-Study/tourism-service-lab-v2 해당 github 프로젝트에 올려주세요. 해당 내용도 계획에 추가해주세요, 그리고 현재 할려는 작업은 AI 스터디성으로 하는거니 지금 계획부터 프롬프트 요청까지 전부다 히스토리나 기록등을 github 에 정리해서 푸쉬해주세요. 해당 내용까지 설계에 추가해서 다시 보고해주세요
