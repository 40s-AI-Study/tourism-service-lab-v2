...
| 4 | [관광지 집중률 방문자 추이 예측 정보](./관광지-집중률-방문자-추이-예측-정보/) | 1 | 0 | 빅데이터 파라미터 추가 학습 필요 |
| 5 | [국문 관광정보 서비스](./국문-관광정보-서비스/) | 15 | 14 |  |
| 6 | [기초지자체 중심 관광지 정보](./기초지자체-중심-관광지-정보/) | 1 | 0 | 빅데이터 파라미터 추가 학습 필요 |
| 7 | [두루누비 정보 서비스](./두루누비-정보-서비스/) | 2 | 2 |  |
| 8 | [무장애 여행 정보](./무장애-여행-정보/) | 13 | 11 |  |
| 9 | [반려동물_동반여행_서비스](./반려동물_동반여행_서비스/) | 13 | 8 |  |
| 10 | [빅데이터_지역별 방문자수](./빅데이터_지역별-방문자수/) | 2 | 0 | 빅데이터 파라미터 추가 학습 필요 |
...
| 15 | [지역별 관광 다양성](./지역별-관광-다양성/) | 3 | 0 | 빅데이터 파라미터 추가 학습 필요 |
| 16 | [지역별 관광 수요 강도](./지역별-관광-수요-강도/) | 2 | 0 | 빅데이터 파라미터 추가 학습 필요 |
| 17 | [지역별 관광 자원 수요](./지역별-관광-자원-수요/) | 2 | 0 | 빅데이터 파라미터 추가 학습 필요 |
