...
h1 { font-size: 15pt; text-align: center; border-bottom: 2px solid #1a56db; padding: 1pt 0; margin: 0 0 2pt; color: #0f172a; }
h2 { font-size: 13pt; color: #fff; background: #1a56db; padding: 2pt 6pt; margin: 4pt 0 2pt; page-break-after: avoid; }
h3 { font-size: 12pt; color: #1a56db; margin: 3pt 0 1pt; padding-bottom: 1pt; border-bottom: 1px solid #cbd5e1; page-break-after: avoid; }
...
img { max-width: 55%; height: auto; display: block; margin: 2pt auto; page-break-inside: avoid; }
img[src*="hero-mockup"] { max-width: 22%; }
img[src*="architecture"] { max-width: 60%; }
img[src*="user-journey"] { max-width: 70%; }
...
<head>
<meta charset="utf-8">
<title>2026 관광데이터 활용 공모전 제안서 — TripCraft Korea (최종)</title>
<style>{CSS}</style>
</head>
<body>
{html_body}
