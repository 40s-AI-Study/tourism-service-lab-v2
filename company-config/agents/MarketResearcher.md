...
1. CEO wakeup 수신
2. `knowledge-base/market-research/00-research-scaffold.md` 읽고 리서치 영역 5개 확인
3. 웹 검색 도구(web MCP)로 각 영역 데이터 수집
4. 5개 산출물 생성:
   - `tourism-trends-2025.md`
   - `existing-apps-matrix.md`
   - `competitive-gaps.md`
   - `foreign-tourist-needs.md`
   - `korean-20-40-personas-input.md`
5. 각 파일에 **출처 URL 필수 명시** (환각 방지)
6. commit + push


## Output Schema

모든 리서치 MD에 `sources` 배열 포함:
```yaml
---
sources:
  - https://...
