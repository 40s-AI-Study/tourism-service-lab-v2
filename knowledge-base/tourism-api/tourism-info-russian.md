...
created: 2026-04-17
source: https://api.visitkorea.or.kr/upload/manual/guide/file/1737596057411.zip
manual_file: knowledge-base/tourism-api/_raw/extracted/tourism-info-russian/
llm_compatibility: universal
status: initial-spec
aliases: ["한국관광공사_노어 관광정보서비스"]
---
...
코드조회 및 관광정보의 통합/상세검색 등의 기능을 제공하며 위치기반, 지역기반 국내 관광에 대한 전반적인 정보를 노어(러시아어)로 제공합니다.
...
- **매뉴얼**: `_raw/extracted/tourism-info-russian/` (Word + Excel)
...
- 활용매뉴얼 docx: `_raw/extracted/tourism-info-russian/`
