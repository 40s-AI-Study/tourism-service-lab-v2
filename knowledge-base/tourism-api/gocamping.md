...
created: 2026-04-17
source: https://api.visitkorea.or.kr/upload/manual/guide/file/1704160387374.zip
manual_file: knowledge-base/tourism-api/_raw/extracted/gocamping/
llm_compatibility: universal
status: initial-spec
aliases: ["한국관광공사_고캠핑 정보 조회서비스"]
---
...
- **매뉴얼**: `_raw/extracted/gocamping/` (Word + Excel)
...
- 활용매뉴얼 docx: `_raw/extracted/gocamping/`
