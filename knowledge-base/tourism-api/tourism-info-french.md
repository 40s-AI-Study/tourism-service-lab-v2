...
created: 2026-04-17
source: https://api.visitkorea.or.kr/upload/manual/guide/file/1737596408255.zip
manual_file: knowledge-base/tourism-api/_raw/extracted/tourism-info-french/
llm_compatibility: universal
status: initial-spec
aliases: ["한국관광공사_불어 관광정보서비스"]
---
...
코드조회 및 관광정보의 통합/상세검색 등의 기능을 제공하며 위치기반, 지역기반 국내 관광에 대한 전반적인 정보를 불어(프랑스어)로 제공합니다.
...
- **매뉴얼**: `_raw/extracted/tourism-info-french/` (Word + Excel)
...
- 활용매뉴얼 docx: `_raw/extracted/tourism-info-french/`
