...
created: 2026-04-17
source: https://api.visitkorea.or.kr/upload/manual/guide/file/1704160495049.zip
manual_file: knowledge-base/tourism-api/_raw/extracted/tourism-info-chinese-simplified/
llm_compatibility: universal
status: initial-spec
aliases: ["한국관광공사_중문 간체 관광정보서비스"]
---
...
- **매뉴얼**: `_raw/extracted/tourism-info-chinese-simplified/` (Word + Excel)
...
- 활용매뉴얼 docx: `_raw/extracted/tourism-info-chinese-simplified/`
